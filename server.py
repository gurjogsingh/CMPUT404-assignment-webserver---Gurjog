...
import socketserver, time, sys, socket, datetime, os, mimetypes
import pathlib
...
class MyWebServer(socketserver.BaseRequestHandler):
    ...
    def sending_to_terminal(self):
        ...
        #how to print current datetime https://docs.python.org/3/library/time.html#time.struct_time
    ...
    def creating_headers(self):
        ...
        if self.code == 200:
            ...
            #https://www.kite.com/python/answers/how-to-get-the-last-modified-time-of-a-file-in-python
    ...
    def bad_request_error(self):
        #format stolen from https://uofa-cmput404.github.io/cmput404-slides/04-HTTP.html#/20
            html_400_code = "<html>\r\n"\
...
#https://docs.python.org/3/library/socketserver.html#socketserver.BaseServer.finish_request
